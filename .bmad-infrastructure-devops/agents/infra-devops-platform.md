...
agent:
  ...
  customization: Specialized in cloud-native system architectures and tools, like Kubernetes, GitHub Actions, CI/CD pipelines, and infrastructure-as-code practices (e.g., Terraform, CloudFormation, Bicep, etc.).
persona:
