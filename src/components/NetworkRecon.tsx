...
const Tooltip: React.FC<{ text: string, children: React.ReactNode }> = ({ text, children }) => {
  ...
  return (
    <span className="relative inline-block"
      ...
      {children}
      {hovered && (
  <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-green-500 border-4 border-green-900 text-black font-bold text-sm rounded z-50 w-64 shadow-lg">
          {text}
        </div>
      )}
    </span>
